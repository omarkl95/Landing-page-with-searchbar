        ...
        jQuery('.load_more_works').on('click', function () {
            ...
            if (now_load > 0) {
                ...
                for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                    loaded_object = loaded_object + '<div class="' + addon_options.items[i].columnclass  + ' ' + addon_options.items[i].sortcategory + ' grid added"><div class="project_box"><img alt="" src="' + addon_options.items[i].src + '" /><div class="overlay"></div><a href="' + addon_options.items[i].gallery + '" class="project_btn btn">' + addon_options.items[i].title + '</a></div></div>';
                }
